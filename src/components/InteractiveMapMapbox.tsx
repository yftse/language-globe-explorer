...
interface InteractiveMapMapboxProps {
  languages: Language[];
  selectedFilter: FilterType;
  onLanguageClick: (language: Language) => void;
}

const InteractiveMapMapbox: React.FC<InteractiveMapMapboxProps> = ({
  languages,
  selectedFilter,
  onLanguageClick
}) => {
  ...
  useEffect(() => {
    ...
    mapboxgl.accessToken = 'pk.eyJ1IjoieWZ0c2UiLCJhIjoiY21jYzJ6dG9yMDQzbDJsc2FjZTR4djhnaCJ9.N36trynl1ncmb-sMnOo_oA';
  ...
  useEffect(() => {
    ...
    console.log('Updating Mapbox map with filter:', selectedFilter, 'and', languages.length, 'languages');
